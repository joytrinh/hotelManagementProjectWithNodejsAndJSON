...
const Luu_tru=require('./Xu_ly/XL_LUU_TRU')
//=======================================
...
Dich_vu.get("/Doc_Khach_san",(req,res)=>{
   var Khach_san = Luu_tru.Doc_Khach_san()
   res.send(Khach_san)
}) 
Dich_vu.get("/Doc_Danh_sach_Phong",(req,res)=>{
   var Danh_sach_Phong=Luu_tru.Doc_Danh_sach_Phong()
   res.send(Danh_sach_Phong)
}) 
Dich_vu.post("/Cho_thue_Phong",(req,res)=>{
   ...
   if(Phong){
      ...
      Phong.TrangThai = 1
      Doi_tuong_B.Kq = Luu_tru.Ghi_Phong(Phong)
   }
   var Chuoi_JSON = JSON.stringify(Doi_tuong_B)
   res.send(Chuoi_JSON)
}) 
Dich_vu.post("/Tra_Phong",(req,res)=>{
   var Doi_tuong_A = req.body
   var Doi_tuong_B = {Kq:'NOT OK'}
   var Danh_sach_Phong=Luu_tru.Doc_Danh_sach_Phong()
   var Phong = Danh_sach_Phong.find(x=> x.Ma_so == Doi_tuong_A.Ma_so)
   if(Phong){
      ...
      Phong.TrangThai = 0
      var ghi = Luu_tru.Ghi_Phong(Phong)
      Doi_tuong_B.Kq = TienThue.toString()            
   }
   var Chuoi_JSON = JSON.stringify(Doi_tuong_B)
   res.send(Chuoi_JSON)
}) 
Dich_vu.post("/Thong_ke",(req,res)=>{
   var Doi_tuong_A = req.body
   var Nam = Doi_tuong_A.Nam
   var Doi_tuong_B = Luu_tru.Thong_ke_tung_thang(Nam)   
   var Chuoi_JSON = JSON.stringify(Doi_tuong_B)
   res.send(Chuoi_JSON)
}) 
Dich_vu.listen(PORT)